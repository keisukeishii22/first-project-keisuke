...
- `CLAUDE.md` — ルールの正本一覧と運用の要点(Claude Code が常に参照)
- `12週テーママップ.md` — 12週分のテーマ×4展開(note/リール/カルーセル/ストーリーズ)と共通ルール
- `文章スタイルガイド.md` — 文体ルール(自然な文章の書き方。モデルが変わっても品質を維持するための正本)
- `自動運用ルーティーン.md` — 指示がなくても週次で動く手順・生成ゲート・起動方法
